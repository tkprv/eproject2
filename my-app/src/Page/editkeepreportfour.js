...
const Editkeepreportfour = () => {
  ...
  const updatequartercharges = async (id, proid, editquartercharges, checked, statusreport) => {
    ...
    await updatereportfour(proid, statusreport)
  ...
  const updatereportfour = async (id, statusreport) => {
    console.log('tt', id)
    axios
      .put(`http://localhost:3001/editkeepreport/updatereportfour/${id}`, {
        status_report4: statusreport
      })
  }
...
export default Editkeepreportfour