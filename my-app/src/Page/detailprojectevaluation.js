                        ...
                        <div style={{ marginTop: '2em' }} >
                            <TabView>
                                <TabPanel header="รายละเอียดโครงการ">
                                    <div align="left">
                                        <h3>รายละเอียดโครงการ {(location.state.close_project === 0) ? <Button label="ขอปิดโครงการ" severity="danger" style={{ marginLeft: '56em' }} onClick={() => onClick('confirm')} /> : <Button label="ขอปิดโครงการ" severity="danger" style={{ marginLeft: '56em' }} disabled />}</h3>
                                        <Card>
                                            <div className="fit">
                                                    ...
                                                    <div className="col-12 md:col-9">
                                                        <h4>
                                                            <DataTable value={objectiveproject} columnResizeMode="fit" showGridlines responsiveLayout="scroll" rows={10}>
                                                                ...
                                                                <Column body={dataobjective} header="จัดการ" />
                                                            </DataTable>
                                                        </h4>
                                                    </div>
                                                </div>
