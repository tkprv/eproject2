...
const Addreportthree = () => {
  ...
  const createquarterchargestthree = async (id, statusreport) => {
    axios
      .post(`http://localhost:3001/addreport/createquartercharges`, {
        ...
        createdetailthree(res.data.insertId)
        createproblemthree(res.data.insertId)
      })
    await updatereportthree(id, statusreport)
  }
  ...
  const showConfirm1 = (value) => {
    confirm({
      title: "ต้องการจัดเก็บรายงานความก้าวหน้าไตรมาส 3 ใช่มั้ย?",
      icon: <ExclamationCircleFilled />,
      onOk() {
        console.log("OK");
        createquarterchargestthree(value, 0)
  ...
  const showConfirm2 = (value) => {
    confirm({
      title: "ต้องการส่งรายงานความก้าวหน้าไตรมาส 3 ใช่มั้ย?",
      icon: <ExclamationCircleFilled />,
      onOk() {
        console.log("OK");
        createquarterchargestthree(value, 1)
      },
      onCancel() {
        console.log("Cancel");
      },
