...
const Managerreporttwo = () => {
  ...
  const openreport = (id, n) => {
    axios
      .put(`http://localhost:3001/dataproject/openreporttwo/${id}`, {
        open_reporttwo: n
      })
  ...
  const showConfirm1 = (value) => {
    confirm({
      title: "ต้องการเปิดใช่รายงานความก้าวหน้าไตรมาส 2 ใช่มั้ย?",
        ...
        <div className="page-wrapper">
          <Card>
            <Panel header='รายงานความก้าวหน้าไตรมาส 2'>
              <Button icon="pi pi-eye" label="เปิดใช้รายงานความก้าวหน้าไตรมาส 2" severity="info" style={{ marginLeft: '54em', height: '2.5em', marginBottom: '1em' }} onClick={() => showConfirm1(location.state.project_id)} />
              <div className="fit">
...
export default Managerreporttwo