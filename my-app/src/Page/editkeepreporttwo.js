...
const Editkeepreporttwo = () => {
  ...
  const updatequartercharges = async (id, proid, editquartercharges, checked, statusreport) => {
    ...
    await updatereporttwo(proid, statusreport)
  ...
  const updatereporttwo = async (id, statusreport) => {
    console.log('tt', id)
    axios
      .put(`http://localhost:3001/editkeepreport/updatereporttwo/${id}`, {
...
export default Editkeepreporttwo