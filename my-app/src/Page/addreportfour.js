...
const Addreportfour = () => {
  ...
  // useEffect(() => {
  //   showreportfour(reportid)
  //   createdetailfour(reportid)
  //   createproblemfour(reportid)
  // }, [reportid])
  ...
  const createquarterchargesfour = async (id, statusreport) => {
    axios
      .post(`http://localhost:3001/addreport/createquartercharges`, {
        ...
        createdetailfour(res.data.insertId)
  ...
  const updatereportfour = async (id, statusreport) => {
    axios
      .put(`http://localhost:3001/addreport/updatereportfour/${id}`, {
        report_four: 4,
        status_report4: statusreport
      })
  }

  const showreportfour = async (item) => {
    axios
  ...
  const createdetailfour = async (id) => {
    axios
      .post(`http://localhost:3001/addreport/createdetail`, {
        ...
        showreportfour()
        createdetailfour2(id)
      })
  }

  const createdetailfour2 = (id) => {
  ...
  const createproblemfour = async (id) => {
    axios
      .post(`http://localhost:3001/addreport/createproblem`, {
        ...
        showreportfour()
        createproblemfour2(id)
      })
  }

  const createproblemfour2 = (id) => {
    if (rowsData2.length !== 0 && rowsData2 !== null) {
      for (const value of rowsData2) {
        const problemfour = value.rowsData2
        try {
