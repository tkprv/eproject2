        ...
        try {
            ...
            await axios
                .post("http://localhost:3001/new/createnewproject", {
                    ...
                    workplan_id: (alldata.selectedbudget === "ไม่ได้ใช้งบประมาณ") ? null : alldata.workplan2.workplan_id,
        ...
        <>
            ...
            <div className={`main-wrapper ${menu ? 'slide-nav' : ''}`}>
                <div className="page-wrapper">
                    <div align="left">
                        <h3 style={{ marginTop: '.5em', marginLeft: '1em', marginBottom: '.5em' }}>สร้างโครงการใหม่</h3>
                        <Toast ref={toast} />
                        <Form
                            form={form}
                            onFinish={onFinish}
                        ...
                        >
                            ...
                            <div className="fit" style={{ marginLeft: '1em' }}>
                                <div className="grid p-fluid">
                                    <div className="col-12 md:col-3">
                                        ...
                                        >
                                            <Input style={{ width: '30em', marginLeft: '7.6em' }} placeholder="กรุณาเพิ่มชื่อโครงการ" />
                                        </Form.Item>
                                    </div>
                                </div>
                            </div>
                            <div className="fit" style={{ marginLeft: '2.5em' }}>
                                <div className="grid p-fluid">
                                    <div className="col-12 md:col-5">
                                        ...
                                        >
                                            <Input style={{ width: '30em' }} placeholder="" disabled />
                                        </Form.Item>
                                    </div>
                                </div>
                            </div>
                            <div className="fit" style={{ marginLeft: '1.5em' }}>
                                <div className="grid p-fluid">
                                    <div className="col-12 md:col-4">
                                        ...
                                        >
                                            <Input style={{ marginLeft: '4.1em', width: '30em' }} placeholder="headproject" disabled />
                                        </Form.Item>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="fit" style={{ marginLeft: '6.2em' }}>
                                <div className="grid p-fluid">
                                    <div className="col-12 md:col-4">
                                        <Form.List name="namestraegicproject" {...formItemLayout}>
                                            {(fields, { add, remove }, { errors }) => (
                                                <>
                                                    <Col>
                                                        {fields.map((field, index) => (
                            ...
                            <div className="fit">
                                <div className="grid p-fluid" >
                                    <div className="col-12 md:col-4">
                                        ...
                                        >
                                            <Radio.Group>
                                                <Radio value="1" style={{ marginTop: '.5em', marginLeft: '7.4em' }}>โครงการในแผน</Radio>
                                                <Radio value="0" style={{ marginTop: '.5em', marginLeft: '7.4em' }}>โครงการนอกแผน</Radio>
                                            </Radio.Group>
                                        </Form.Item>
                                    </div>
                                </div>
                            ...
                            <div className="fit">
                                <div className="grid p-fluid">
                                    <div className="col-12 md:col-4">
                                        ...
                                        >
                                            <Radio.Group>
                                                <Radio value="0" style={{ marginTop: '.5em', marginLeft: '7.4em'}}>โครงการใหม่</Radio>
                                                <Radio value="1" style={{ marginTop: '.5em', marginLeft: '7.4em' }}>โครงการต่อเนื่อง</Radio>
                                                <Radio value="2" style={{ marginTop: '.5em', marginLeft: '7.4em' }}>งานประจำ</Radio>
                                                <Radio value="3" style={{ marginTop: '.5em', marginLeft: '7.4em' }}>งานพัฒนา</Radio>
                                            </Radio.Group>
                                        </Form.Item>
                                    </div>
                                </div>
                            ...
                            <div className="fit">
                                <div className="grid p-fluid" style={{ marginLeft: '1.8em' }}>
                                    <div className="col-12 md:col-4">
                                        <Form.Item
                                            {...formItemLayout}
                                        ...
                                        >
                                            <Select
                                                size="large"
                                                style={{ width: 400, marginLeft: '4.6em' }}
                                        ...
                                        {selectintegration !== "ไม่มี" && (
                                            <Form.Item
                                                ...
                                                rules={[
                                                    {
                                                        required: true,
                                                        message: "กรุณาเพิ่มเรื่อง/วิชา/คณะ",
                                                    },
                                                ]}
                                            >
                                                <Input.TextArea style={{ marginLeft: '8em' }} rows={4} cols={200}/>
                                            </Form.Item>
                                        )}
                                    </div>
                                </div>
                            ...
                            <div className="fit">
                                <div className="grid p-fluid" style={{ marginLeft: '.7em' }}>
                                    <div className="col-12 md:col-4">
                                        <Form.Item
                                            {...formItemLayout}
                                            name="reason"
                                        ...
                                        >
                                            <Input.TextArea style={{ marginLeft: '6.3em' }} rows={3} cols={800} showCount />
                                        </Form.Item>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="fit">
                                <div className="grid p-fluid" style={{ marginLeft: '3em' }}>
                                    <div className="col-12 md:col-4">
                                        <Form.Item
                                            {...formItemLayout}
                                            name="selectedbudget"
                                            label="ประเภทงบประมาณที่ใช้"
                                            rules={[
                                                {
                                                    required: true,
                            ...
                            {selectedbudget !== "ไม่ได้ใช้งบประมาณ" && (
                                <>
                                    <div className="fit">
                                        <div className="grid p-fluid" style={{ marginLeft: '4.5em' }}>
                                            <div className="col-12 md:col-4">
                                    ...
                                    <div className="fit">
                                        <div className="grid p-fluid" style={{ marginLeft: '.01em' }}>
                                            <div className="col-12 md:col-3">
                                                <Form.Item
                                                    {...formItemLayout}
                                                    name="workplan2"
                                                ...
                                                >
                                                    {(fields, { add, remove }, { errors }) => (
                                                        <>
                                                            ...
                                                            <Form.Item {...formItemLayout} label="ประเภทการใช้จ่าย">
                                                                <Button
                                                                    type="dashed"
                                                                    onClick={() => add()}
                                                                    block
                            ...
                            <div className="fit">
                                <div className="grid p-fluid" style={{ marginLeft: '.4em' }}>
                                    <div className="col-12 md:col-3">
                            ...
                            <div className="fit">
                                <div className="grid p-fluid" style={{ marginLeft: '2.1em' }}>
                                    <div className="col-12 md:col-3">
                                        <Form.Item
                                            {...formItemLayout}
                                            name="radioTor"
